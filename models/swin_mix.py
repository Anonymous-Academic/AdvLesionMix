...
class Features(nn.Module):
    def __init__(self, net_layers, breaks):
        ...
        self.net_layer_5 = nn.Sequential(net_layers[2])        
...
def swin_s_mix(num_class, inner_dim=256, generator_wrapper="Generator_Wrapper"):
    ...
    import timm
    net = timm.create_model("swin_small_patch4_window7_224.ms_in1k", pretrained=True)
