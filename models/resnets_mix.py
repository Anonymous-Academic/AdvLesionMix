...
def Resnet18_mix(num_class, inner_dim=256, generator_wrapper="Generator_Wrapper"):
...
def Resnet34_mix(num_class, inner_dim=256, generator_wrapper="Generator_Wrapper"):
