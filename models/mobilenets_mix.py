...
class Features(nn.Module):
    def __init__(self, net_layers_FeatureHead, breaks):
        ...
        net_layers_ = list(net_layers_FeatureHead[2].children())
        
        
        self.net_layer_0 = nn.Sequential(*(
            net_layers_FeatureHead[0:2] + net_layers_[0:4]                                                                   
        ))
        self.net_layer_1 = nn.Sequential(net_layers_[4])
        self.net_layer_2 = nn.Sequential(*((net_layers_[5:7])+net_layers_FeatureHead[3:5]))
        # print()
...
def mobilenetv2_050_mix(num_class, inner_dim=256, generator_wrapper="Generator_Wrapper"):
    ...
    import timm
    net = timm.create_model("mobilenetv2_050.lamb_in1k", pretrained=True)
...
def mobilenetv2_100_mix(num_class, inner_dim=256, generator_wrapper="Generator_Wrapper"):
    ...
    import timm
    net = timm.create_model("mobilenetv2_100.ra_in1k", pretrained=True)
